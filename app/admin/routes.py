...
def add_timetable():
    ...
    # Get all courses (JavaScript will filter them)
...
def delete_department(dept_id):
    ...
    # Check if department has students/faculty
    if department.students or department.faculty or department.courses or department.staff:
        flash('Cannot delete department with associated records.', 'danger')
        return redirect(url_for('admin.manage_departments'))
